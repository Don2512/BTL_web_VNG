...
<div class="row">
    ...
    <div class="col-lg-10 col-md-10 col-12">
        ...
        <?php foreach($Product as $item){ ?>
            <div class="card col-6 col-md-4 mt-2">
                ...
                <input type="hidden" name="id" value="<?php echo $item->id ?>">
                    ...
                    <h5 class="card-title c-orange fs-20px fw-bold"><?php echo $item->name ?></h5>
                    <div class="row mt-3 mr-1">
                        <div class="col-lg-6 c-orange fs-20px fw-bold">
                            $<?php echo $item->price ?>0
                        </div>
                        <div class="col-lg-6">
                            <button type="submit" class="btn btn-block btn-primary btn-circle btn-icon-left" name="mua">
