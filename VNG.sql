...
CREATE TABLE Comment (
    ...
    PRIMARY KEY(employee_id, blog_id, time_commented),
...
CREATE TABLE Review (
    ...
    PRIMARY KEY (customer_id, blog_id),
...
CREATE TABLE CustomerComment (
    ...
    content TEXT,
    time_commented DATETIME,
    PRIMARY KEY (customer_id, blog_id, time_commented),
    FOREIGN KEY (customer_id) REFERENCES Customer(customer_id),
    FOREIGN KEY (blog_id) REFERENCES blog(blog_id)
);
...
INSERT INTO blog (title, content, time_published, category, author_id) VALUES
...
INSERT INTO Comment (employee_id, blog_id, content, time_commented) VALUES
(1, 1, 'Bình luận 1', NOW()),
(2, 2, 'Bình luận 2', NOW());

INSERT INTO Review (customer_id, blog_id, rating, time_reviewed) VALUES
(1, 1, 5, NOW()),
(2, 2, 4, NOW());

INSERT INTO CustomerComment (customer_id, blog_id, content, time_commented) VALUES
